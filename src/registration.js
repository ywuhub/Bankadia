                        ...
                        <div class="account-details"> 
                            ...
                            <div class="register-row">
                                <div class="register-col">
                                    <label for="email" class="account_label">Email:</label> <input type="text" name="email" required/><br/>
                                </div>
                                <div class="register-col">
                                    <label for="password" class="account_label">Password:</label> <input type="password" name="password" required/>
                                </div>
                            </div>
                            <div class="register-row">
                                <div class="register-col">
                                    <label for="confirm_email" class="account_label">Confirm Email:</label> <input type="text" name="confirm_email" required/><br/>
                                </div>
                                <div class="register-col">
                                    <label for="confirm_password" class="account_label">Confirm Password:</label> <input type="password" name="confirm_password" required/><br/>
                                </div>
                            </div>                                                 
                        </div>
                    </fieldset>
